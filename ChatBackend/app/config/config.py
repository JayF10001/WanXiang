...
class Config:
    ...
    SEARCH_URL = os.getenv('QWEN_BASE_URL', 'https://dashscope.aliyuncs.com/compatible-mode/v1')
    SEARCH_MODEL = os.getenv('QWEN_MODEL', 'qwen-plus')
    ...
    # MongoDB settings
    MONGODB_URI = os.getenv('MONGODB_URI') or os.getenv('MONGO_URI') or 'mongodb://db:27017/'
